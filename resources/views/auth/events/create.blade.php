      ...
      <div class="card-body">
        ...
        <form    method="POST"  class="forms-sample" action="{{ route('events.store') }}">
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control" cols="30" rows="5" placeholder="Enter Description here.."></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="exampleInputCity1" name="price" placeholder="Enter price">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="exampleInputCity1" name="max_attendence" placeholder="1">
          </div>
