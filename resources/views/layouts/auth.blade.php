      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo-mini" href="{{ route('dashboard') }}">
            <span class="text-white text-center">BK</span>
          </a>
          <a class="sidebar-brand brand-logo fs-4" href="{{ route('dashboard') }}" style="text-decoration: none;color:white;">
            <span class="text-center">{{ config('app.name') }}</span>
          </a>
        </div>
        <ul class="nav">
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Booking.com 2020</span>
